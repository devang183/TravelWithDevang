      ...
      <div className="relative max-w-6xl mx-auto px-4 py-12 sm:py-20">
        ...
        <Link href="/contributors">
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="mb-8 flex items-center space-x-2 text-purple-600 hover:text-purple-800 font-semibold"
          >
            <span>←</span>
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8 sm:p-12 z-10">
              ...
              >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-full flex items-center space-x-2 transition-all duration-300 hover:scale-105 shadow-lg"
                >
                  <FileText className="h-4 w-4 sm:h-5 sm:w-5" />
                  <span className="text-sm sm:text-base font-semibold">View Portfolio</span>
                </a>
              ...
              {contributions.map((contribution, index) => (
                ...
                >
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-2xl font-bold text-purple-600">{contribution.count}</span>
                  </div>
        ...
        >
          ...
          <div className="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl overflow-hidden">
            ...
            {/* Portfolio Preview/Embed */}
            <div className="p-6 bg-gray-50">
              <div className="aspect-[8.5/11] max-h-[800px] bg-white rounded-lg shadow-inner overflow-hidden">
                <iframe
                  src="https://cityphotoscity.s3.eu-west-1.amazonaws.com/images/contributors/MeghanaKankaria/PortfolioMeghanaKankaria.pdf"
                  className="w-full h-full"
                  title="Meghana Kankaria Portfolio"
                />
              </div>
