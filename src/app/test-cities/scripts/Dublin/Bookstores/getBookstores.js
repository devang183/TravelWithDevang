function hashString(str) {
  ...
  geojson.features.forEach(feature => {
    ...
    // Write output to DublinCityBookstoreData.js
    const outputPath = path.join(__dirname, 'DublinCityBookstoreData.js');
    const outputCode = `export const DublinCityBookstoreData = ${JSON.stringify(cityMapData, null, 2)};`;

    fs.writeFileSync(outputPath, outputCode);
    console.log('✅ Dublin Bookstore data generated successfully.');