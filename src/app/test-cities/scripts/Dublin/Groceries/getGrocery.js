function hashString(str) {
  ...
  geojson.features.forEach(feature => {
    ...
    // Write output to DublinCityGroceryData.js
    const outputPath = path.join(__dirname, 'DublinCityGroceryData.js');
    const outputCode = `export const DublinCityGroceryData = ${JSON.stringify(cityMapData, null, 2)};`;

    fs.writeFileSync(outputPath, outputCode);
    console.log('✅ Dublin Grocery data generated successfully.');