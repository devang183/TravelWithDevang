function hashString(str) {
  ...
  geojson.features.forEach(feature => {
    ...
    // Write output to DublinCityPintData.js
    const outputPath = path.join(__dirname, 'DublinCityPintData.js');
    const outputCode = `export const DublinCityPintData = ${JSON.stringify(cityMapData, null, 2)};`;

    fs.writeFileSync(outputPath, outputCode);
    console.log('✅ Dublin Pints data generated successfully.');