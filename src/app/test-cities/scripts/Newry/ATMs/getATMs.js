function hashString(str) {
  ...
  geojson.features.forEach(feature => {
    ...
    // Write output to NewryCityATMData.js
    const outputPath = path.join(__dirname, 'NewryCityATMData.js');
    const outputCode = `export const NewryCityATMData = ${JSON.stringify(cityMapData, null, 2)};`;

    fs.writeFileSync(outputPath, outputCode);
    console.log('✅ Newry ATM data generated successfully.');