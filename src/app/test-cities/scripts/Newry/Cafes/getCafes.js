function hashString(str) {
  ...
  geojson.features.forEach(feature => {
    ...
    // Write output to NewryCityCafeData.js
    const outputPath = path.join(__dirname, 'NewryCityCafeData.js');
    const outputCode = `export const NewryCityCafeData = ${JSON.stringify(cityMapData, null, 2)};`;

    fs.writeFileSync(outputPath, outputCode);
    console.log('✅ Newry Restaurant data generated successfully.');