function hashString(str) {
  ...
  geojson.features.forEach(feature => {
    ...
    // Write output to NewryCityGroceryData.js
    const outputPath = path.join(__dirname, 'NewryCityGroceryData.js');
    const outputCode = `export const NewryCityGroceryData = ${JSON.stringify(cityMapData, null, 2)};`;

    fs.writeFileSync(outputPath, outputCode);
    console.log('✅ Newry Grocery data generated successfully.');