        ...
        return (
          ...
          >
            <Popup maxWidth={350} maxHeight={400}>
              <div style={{ minWidth: '320px', maxHeight: '380px', overflowY: 'auto' }} className="bg-[white/10] backdrop-blur-md">
                {/* Host Information */}
...
// Main Component
export default function DublinMap() {
  ...
  //using MongoDB fetching
  useEffect(() => {
    const fetchListings = async () => {
      setLoading(true);
      try {
        const res = await fetch("/api/listingsDublin");
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center h-screen">
        <div className="text-xl">Loading Dublin listings...</div>
      </div>
    );
  }
...
// import Papa from "papaparse";
// import 'leaflet/dist/leaflet.css';
// import { neighborhoodsList } from "./neighbourhoodList";
...
//           <div>
//             <label className="block text-sm font-medium mb-1">Neighborhoods:</label>
//             <div className="h-40 overflow-y-auto border border-gray-300 p-2 rounded bg-gray-50">
//               {neighborhoodsList.map((n, i) => (
//                 <div key={i} className="mb-1">
//                   <label className="inline-flex items-center text-sm cursor-pointer hover:bg-gray-100 w-full p-1 rounded">
//                     <input
//                       type="checkbox"
//                       value={n}
