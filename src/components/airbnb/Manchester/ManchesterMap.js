...
import { neighborhoodsList } from "@/components/airbnb/Manchester/neighbourhoodList.js";
              ...
              <div style={{ minWidth: '320px', maxHeight: '380px', overflowY: 'auto' }}>
                ...
                <div style={{ marginBottom: '12px' }}>
                  ...
                  <div style={{ fontSize: '14px', lineHeight: '1.4' }}>
                    ...
                    <b>Neighbourhood:</b> {listing.neighbourhood_group_cleansed}<br/>
...
// Main Component
export default function ManchesterMap() {
...
//   useEffect(() => {
//     setLoading(true);
//     Papa.parse('/listings-manchester.csv', {
//       download: true,
//       header: true,
//       complete: (result) => {
//         try {
...
//               neighbourhood_group_cleansed: r.neighbourhood_group_cleansed || 'Unknown',
...
useEffect(() => {
    const fetchListings = async () => {
      setLoading(true);
      try {
        const res = await fetch("/api/listingsManchester");
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center h-screen">
        <div className="text-xl">Loading Manchester listings...</div>
      </div>
    );
  }
