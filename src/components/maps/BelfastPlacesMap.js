...
export default function BelfastPlacesMap() {
    ...
    <div className="mt-6 w-full rounded-2xl shadow-2xl overflow-hidden backdrop-blur-sm bg-white/10">
      ...
      >
        <span className="font-medium text-white text-center">
          {isOpen ? 'Belfast Places to Visit' : 'Show Places to Visit in Belfast'}
        </span>
      ...
      {isOpen && (
        <div className="p-4">
          ...
          >
            <iframe
              src="https://www.google.com/maps/d/u/0/embed?mid=1PCDC2SmZyvLyj0whsmVZx8CLWEL45HY&ehbc=2E312F"
              style={{
                position: 'absolute',
                top: 0,
                left: 0,
              ...
              loading="lazy"
              title="Belfast Places to Visit Map"
            />
          </div>
        </div>
      )}
