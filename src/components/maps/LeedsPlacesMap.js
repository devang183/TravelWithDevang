...
export default function LeedsPlacesMap() {
    ...
    <div className="mt-6 w-full rounded-2xl shadow-2xl overflow-hidden backdrop-blur-sm bg-white/10">
      ...
      >
        <span className="font-medium text-white text-center">
          {isOpen ? 'Leeds Places to Visit' : 'Show Places to Visit in Leeds'}
        </span>
      ...
      {isOpen && (
        <div className="p-4">
          ...
          >
            <iframe
              src="https://www.google.com/maps/d/u/0/embed?mid=12FKFL0a6eqDfL6u8Fui--Lh8X_munks&ehbc=2E312F"
              style={{
                position: 'absolute',
                top: 0,
                left: 0,
              ...
              loading="lazy"
              title="Leeds Places to Visit Map"
            />
          </div>
        </div>
      )}
