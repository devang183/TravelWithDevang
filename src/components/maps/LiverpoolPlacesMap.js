...
export default function LiverpoolPlacesMap() {
    ...
    <div className="mt-6 w-full rounded-2xl shadow-2xl overflow-hidden backdrop-blur-sm bg-white/10">
      ...
      >
        <span className="font-medium text-white text-center">
          {isOpen ? 'Liverpool Places to Visit' : 'Show Places to Visit in Liverpool'}
        </span>
      ...
      {isOpen && (
        <div className="p-4">
          ...
          >
            <iframe
              src="https://www.google.com/maps/d/u/0/embed?mid=1T9sFEIDU3R_j2X7DdMocs40sZ7LMVMI&ehbc=2E312F"
              style={{
                position: 'absolute',
                top: 0,
                left: 0,
              ...
              loading="lazy"
              title="Liverpool Places to Visit Map"
            />
          </div>
        </div>
      )}
