...
export default function NagpurPoliceStationsMap() {
    ...
    <div className="mt-6 w-full rounded-2xl shadow-2xl overflow-hidden backdrop-blur-sm bg-white/10">
      ...
      >
        <span className="font-medium text-white text-center">
          {isOpen ? 'Comprehensive Police Stations Map of Nagpur' : 'Show Police Stations Map of Nagpur'}
        </span>
      ...
      {isOpen && (
        <div className="p-4">
          ...
          >
            <iframe
              src="https://www.google.com/maps/d/embed?mid=1A5XEbg78sfY6qJ12fCcitXWURQCjqqQ&ehbc=2E312F"
              style={{
                position: 'absolute',
                top: 0,
                left: 0,
              ...
              loading="lazy"
              title="Nagpur Police Stations Map"
            />
          </div>
        </div>
      )}
